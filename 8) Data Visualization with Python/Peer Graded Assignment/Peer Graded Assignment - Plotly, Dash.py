...
app.layout = html.Div([
    ...
    # Task 2.3 - Add a div for output display
    html.Div([
...
#TASK 2.5: Create and display graphs for Recession Report Statistics
 ...
 # Plot 1: Average Automobile sales fluctuate over Recession Period (year-wise)
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                names='Vehicle_Type',
                title='Share of Advertising Expenditure by Vehicle Type during Recessions'
            )
        )
